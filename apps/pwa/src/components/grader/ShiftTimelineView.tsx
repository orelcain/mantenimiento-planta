        ...
        <CardTitle className="text-base flex items-center gap-2 flex-wrap">
          ...
          {onUploadClick && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-ctl border border-transparent bg-primary/[0.15] text-brand-ink hover:bg-primary/[0.15] active:bg-primary/[0.15] transition-colors text-caption font-medium"
