        ...
        {!loading && !error && breakdown.total > 0 && (
          <div className="overflow-y-auto flex-1 pr-1 space-y-4">
            ...
            {breakdown.total > 0 && breakdown.p0 === 0 && (
              <div className="flex items-center gap-2 px-3 py-2 rounded-ctl border border-emerald-500/[0.25] bg-emerald-500/[0.08] text-xs text-emerald-600">
            ...
            {breakdown.p0 > 0 && breakdown.topP0Cause && (
              <div
                className={cn(
                  ...
                  breakdown.p0Status === 'critical' && 'border-cat-5-tint/[0.25] bg-cat-5-tint/[0.08]',
                  breakdown.p0Status === 'alert'    && 'border-amber-500/[0.25] bg-amber-500/[0.08]',
                  breakdown.p0Status === 'ok'       && 'border-emerald-500/[0.25] bg-emerald-500/[0.08]',
                )}
            ...
            {breakdown.missingProductiveDetail && (
              <div className="flex items-start gap-2 px-3 py-2 rounded-ctl border border-amber-500/[0.25] bg-amber-500/[0.08] text-xs text-amber-600">
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isP0
                          ? 'border-cat-4-tint/[0.25] bg-cat-4-tint/[0.08]'
                    ...
                    >
                      <span
                        className={cn(
                          ...
                          isP0 ? 'bg-cat-4-tint/[0.08] text-cat-4-ink' : 'bg-emerald-500/[0.08] text-emerald-600',
                        )}
                      >
                        {isP0 ? 'P0' : `G${gate}`}
                      </span>
