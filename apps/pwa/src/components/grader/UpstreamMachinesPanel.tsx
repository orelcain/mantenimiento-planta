...
function LineTimeSummaryBadges({ totals }: { totals: LineTimeTotals }) {
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap" title="Suma de tiempos de las 3 Baaders (horas-máquina, no tiempo de línea)">
      <Badge
        variant="outline"
        className="bg-emerald-500/[0.15] border-emerald-900 text-emerald-300 tabular-nums text-[11px] px-2 py-0.5 h-5"
      ...
      {totals.downtimeSec > 0 && (
        <Badge
          variant="outline"
          className="bg-cat-5-tint/[0.15] border-rose-900 text-rose-300 tabular-nums text-[11px] px-2 py-0.5 h-5"
      ...
      {totals.breakSec > 0 && (
        <Badge
          variant="outline"
          className="bg-amber-500/[0.15] border-amber-900 text-amber-300 tabular-nums text-[11px] px-2 py-0.5 h-5"
    ...
    <div className={cn('py-3 pl-3 pr-1 space-y-2 rounded-ctl border-l-4', accent.bg, accent.border)}>
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          {microAlert && (
            <Badge variant="outline" className="text-[10px] px-1.5 py-0 h-4 border-amber-500/[0.25] bg-amber-500/[0.15] text-amber-300 flex items-center gap-1" title="Microparadas anómalas (>50% sobre promedio línea). Revisar mantención.">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {isZoomActive && (
          <Badge
            variant="outline"
            className="bg-cat-6-tint/[0.15] border-violet-800 text-violet-300 text-[10px] px-1.5 py-0.5 h-5 gap-1"
        ...
        <div className="w-full flex items-center justify-between gap-3 flex-wrap">
          ...
          >
            ...
            {dataSource === 'demo' && (
              <Badge
                variant="outline"
                className="text-[10px] px-1.5 py-0 h-4 border-amber-500/[0.25] text-amber-400 bg-amber-500/[0.15]"
...
` +
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground ml-auto flex-wrap justify-end">
            ...
            {correlationSummary && correlationSummary.upstreamCaused > 0 && (
              <Badge
                variant="outline"
                className="bg-cat-4-tint/[0.15] border-orange-800 text-orange-300 text-[10px] px-2 py-0.5 h-5 gap-1 cursor-help"
                title={
            ...
            {slxWindowMismatch && (
              <Badge
                variant="outline"
                className="bg-cat-5-tint/[0.15] border-rose-800 text-rose-300 text-[10px] px-2 py-0.5 h-5 gap-1 cursor-help"
                title={
