    ...
    <Card>
      <CardHeader className="pb-0 pt-3">
        <CardTitle className="text-sm flex items-center gap-2 flex-wrap">
          ...
          {/* Especie del turno */}
          {displaySpecies ? (
            <span className={cn('flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded-ctl border font-normal', SPECIES_CSS[displaySpecies])}>
          ...
          {isSynthetic && (
            <span
              className="text-[10px] px-1.5 py-0.5 rounded-ctl bg-muted text-muted-foreground border border-border cursor-help"
          ...
          {allowEdit && (
            <>
              <button
                ...
                className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-ctl border border-primary/30 bg-primary/5 text-primary hover:bg-primary/10 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-ctl border border-muted-foreground/20 bg-muted text-muted-foreground hover:bg-accent hover:text-foreground transition-colors"
              >
