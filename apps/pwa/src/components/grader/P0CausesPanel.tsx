...
const COLOR_CLASSES: Record<string, { badge: string; bar: string }> = {
  red:     { badge: 'bg-red-500/[0.15] text-red-400',       bar: 'bg-fill-critical'   },
  ...
  emerald: { badge: 'bg-emerald-500/[0.15] text-emerald-400', bar: 'bg-fill-ok' },
  amber:   { badge: 'bg-amber-500/[0.15] text-amber-400',   bar: 'bg-fill-warning' },
  brown:   { badge: 'bg-amber-500/[0.15] text-ink-warn', bar: 'bg-fill-warning' },
  blue:    { badge: 'bg-primary/[0.15] text-blue-400',     bar: 'bg-primary'  },
  zinc:    FALLBACK_COLOR,
}
