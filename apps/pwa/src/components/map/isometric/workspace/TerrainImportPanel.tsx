...
export function TerrainImportPanel({
  ...
  return (
    <div className="space-y-4 rounded-xl border bg-muted/20 p-4">
      ...
      <div className={isHorizontal ? 'grid gap-4' : 'space-y-3'}>
        <div className="space-y-3">
          <div className="space-y-1">
            ...
            <Textarea
              ...
              rows={coordinateRows}
              className="min-h-[220px] resize-none text-[12px] font-mono leading-6"
            ...
            <div className="space-y-2 rounded-lg border bg-background/70 p-3">
              ...
              {preview && (
                <div className="grid gap-2 text-[11px] text-muted-foreground">
                  <div>Rectángulo estimado: <span className="font-medium text-foreground">{Math.round(preview.rectangleWidthMeters)} m × {Math.round(preview.rectangleDepthMeters)} m</span></div>
