                    ...
                    {siblingNodes.map(s => {
                      ...
                      return (
                        <button key={s.id} type="button"
                          ...
                          className={`px-2 py-1 rounded-ctl text-caption font-medium border transition-all ${checked ? 'border-primary/40 bg-primary/10 text-brand-ink' : 'border-border bg-card text-muted-foreground hover:bg-muted/20'}`}>
                          {s.nombre}
                        </button>
                      )
                    })}
