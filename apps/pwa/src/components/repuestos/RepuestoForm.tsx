                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button type="button" onClick={() => setTarget('shared')}
                      className={`flex-1 px-3 py-2 rounded-card text-xs font-medium border transition-all ${target === 'shared' ? 'border-transparent bg-primary/[0.15] text-brand-ink' : 'border-border bg-card text-muted-foreground hover:bg-muted/20'}`}>
                    ...
                    {siblingNodes.map(s => {
                      ...
                      return (
                        <button key={s.id} type="button"
                          ...
                          className={`px-2 py-1 rounded-ctl text-caption font-medium border transition-all ${checked ? 'border-transparent bg-primary/10 text-brand-ink' : 'border-border bg-card text-muted-foreground hover:bg-muted/20'}`}>
                          {s.nombre}
                        </button>
                      )
                    })}
