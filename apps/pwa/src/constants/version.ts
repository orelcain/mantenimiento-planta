 ...
 */
export const APP_VERSION = '3.89.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-grader): Explorador CAN — tabla de dispositivos + Localizar ID\'s aleatorias' as const
