 ...
 */
export const APP_VERSION = '3.11.0' as const
 ...
 */
export const VERSION_NAME = 'fix(grader-yal): copy generico P0Causes + simplifica breakdowns single-value + axis padding 10->2min' as const
