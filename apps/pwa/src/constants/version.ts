 ...
 */
export const APP_VERSION = '2.111.0' as const
 ...
 */
export const VERSION_NAME = 'feat(grader): selección turno calendario → Config via store + tooltips FishBase + pico cadencia' as const
