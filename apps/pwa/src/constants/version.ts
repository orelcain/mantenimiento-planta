 ...
 */
export const APP_VERSION = '3.89.2' as const
 ...
 */
export const VERSION_NAME = 'fix(hmi-grader): árbol de Cambiar Parametros como acordeón real (contenido inline, no panel separado)' as const
