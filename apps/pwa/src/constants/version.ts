 ...
 */
export const APP_VERSION = '3.18.0' as const
 ...
 */
export const VERSION_NAME = 'fix(grader-yal): chips SLX con Excel parcial + banner produccion no significativa + KPI totalCycles' as const
