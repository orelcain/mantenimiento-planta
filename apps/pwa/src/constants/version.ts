 ...
 */
export const APP_VERSION = '3.9.0' as const
 ...
 */
export const VERSION_NAME = 'feat(grader-yal): flujo eviscerado simplificado + clasificacion errores Yal + fix duplicacion pieces' as const
