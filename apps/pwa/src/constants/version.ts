 ...
 */
export const APP_VERSION = '3.25.0' as const
 ...
 */
export const VERSION_NAME = 'feat(mobile-ux): 9 mejoras UI/UX vista móvil (header, KPI 2x2, calendar, tabs, etc.)' as const
