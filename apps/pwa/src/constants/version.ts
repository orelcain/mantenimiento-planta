 ...
 */
export const APP_VERSION = '3.30.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-yal): validador manual con video real + paint mode + snapshots persistentes' as const
