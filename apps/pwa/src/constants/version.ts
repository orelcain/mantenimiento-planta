 ...
 */
export const APP_VERSION = '3.61.0' as const
 ...
 */
export const VERSION_NAME = 'feat(repuestos): el sidebar de áreas ahora muestra los equipos colgando de su área según la jerarquía' as const
