 ...
 */
export const APP_VERSION = '3.87.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-grader): Lote 2 — Servicio, Probar Entradas, Probar Salidas, Monitor CPU (clonadas contra pantallazos reales)' as const
