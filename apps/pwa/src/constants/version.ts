 ...
 */
export const APP_VERSION = '3.64.0' as const
 ...
 */
export const VERSION_NAME = 'feat(repuestos): favoritos de equipos desde el sidebar + filtro "ver solo favoritos" (áreas y equipos)' as const
