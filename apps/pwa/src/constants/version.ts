 ...
 */
export const APP_VERSION = '3.27.0' as const
 ...
 */
export const VERSION_NAME = 'refactor(shift-display): convención unificada de denominación + íconos por turno' as const
