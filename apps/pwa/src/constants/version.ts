 ...
 */
export const APP_VERSION = '3.13.0' as const
 ...
 */
export const VERSION_NAME = 'fix(grader): pausas dominantes con markLine + demo bloqueado fuera de chonchi + tooltips KPI + cleanup' as const
