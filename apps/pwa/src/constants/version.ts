 ...
 */
export const APP_VERSION = '3.23.0' as const
 ...
 */
export const VERSION_NAME = 'feat(grader-calendar): tooltips fuente·unidad + Único turno + labels T1/T2/T3 Yal' as const
