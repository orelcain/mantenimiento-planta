 ...
 */
export const APP_VERSION = '3.14.0' as const
 ...
 */
export const VERSION_NAME = 'feat(grader-yal): peso kg con miles + CERRADO con hora + reglas IA Yal explicitas + QuickChange Yal especifico + KPI No clasifica' as const
