 ...
 */
export const APP_VERSION = '3.9.1' as const
 ...
 */
export const VERSION_NAME = 'feat(grader): tooltip upstream + InfoTooltip mas visible + bulk gates + reclassify Yal' as const
