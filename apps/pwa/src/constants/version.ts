 ...
 */
export const APP_VERSION = '3.86.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-grader): Lote 1 — Menu, Velocidad cintas, Resultados Clasificación, Estado (clonadas contra pantallazos reales)' as const
