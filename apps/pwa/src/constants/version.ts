 ...
 */
export const APP_VERSION = '3.19.0' as const
 ...
 */
export const VERSION_NAME = 'fix(grader-yal): chip madrugada label M + Unscheduled umbral 50 en subscribeAuto' as const
