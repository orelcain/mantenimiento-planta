 ...
 */
export const APP_VERSION = '3.10.2' as const
 ...
 */
export const VERSION_NAME = 'fix(grader-yal): ocultar 4 secciones Chonchi-only mas (correlation, history, AI, config)' as const
