 ...
 */
export const APP_VERSION = '3.12.0' as const
 ...
 */
export const VERSION_NAME = 'feat(grader-yal): generador IA Yal-specifico (peso bajo + proximidad + throughput + uptime Baader)' as const
