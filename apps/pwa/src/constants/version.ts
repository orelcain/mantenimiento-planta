 ...
 */
export const APP_VERSION = '3.82.0' as const
 ...
 */
export const VERSION_NAME = 'feat(aria): avisos proactivos v2 — preventiva vencida + equipo crítico + incidencia vieja + móvil' as const
