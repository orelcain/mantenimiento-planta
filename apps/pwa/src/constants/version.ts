 ...
 */
export const APP_VERSION = '3.88.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-grader): editor Cambiar Parametros — login + árbol Z-Belt/Pockets/Sorting belt/System settings' as const
