 ...
 */
export const APP_VERSION = '3.66.0' as const
 ...
 */
export const VERSION_NAME = 'fix(repuestos): drawer del sidebar opaco en móvil + estrellas de favorito visibles en táctil' as const
