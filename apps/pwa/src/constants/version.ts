 ...
 */
export const APP_VERSION = '3.67.0' as const
 ...
 */
export const VERSION_NAME = 'feat(repuestos): auto-expandir áreas con favoritos al activar el filtro + guías de indentación en el árbol' as const
