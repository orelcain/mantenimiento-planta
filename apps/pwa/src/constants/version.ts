 ...
 */
export const APP_VERSION = '2.114.1' as const
 ...
 */
export const VERSION_NAME = 'fix(grader): FASE 7 — firestore rules 3 colecciones + audit guard moduleConfigLoadedRef + lazy historial' as const
