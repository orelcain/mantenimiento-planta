 ...
 */
export const APP_VERSION = '3.32.0' as const
 ...
 */
export const VERSION_NAME = 'feat(hmi-yal): diff entre snapshots con modal de comparación agrupado por categoría' as const
