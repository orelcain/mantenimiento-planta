 ...
 */
export const APP_VERSION = '2.105.0' as const
 ...
 */
export const VERSION_NAME = 'feat(ux): Grader Config — sub-tabs Fisica Producto Cintas Distancias Calibracion' as const
