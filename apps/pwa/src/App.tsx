...
const GraderLearningPage = lazyWithReload(() => import('@/pages/GraderLearningPage').then((mod) => ({ default: mod.GraderLearningPage })))
  ...
  return (
    <HelpProvider>
        <BrowserRouter basename={import.meta.env.BASE_URL}>
          ...
          {/* El manual del Grader se movio al Centro de Aprendizaje (publico): el
              redirect vive fuera del bloque protegido para que links y bookmarks
              viejos no obliguen a iniciar sesion. */}
