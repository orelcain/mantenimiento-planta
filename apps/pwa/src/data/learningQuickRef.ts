...
const BAADER_142: QuickRefGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Service for Stepmotors', value: 'Ajuste de motores paso a paso. Si el display dice «& Kit», la máquina tiene el Upgrade Kit (y los códigos E770-E775 le aplican)' },
  ...
  {
    title: 'Contadores de fallos por motor paso a paso',
    rows: [
      { label: 'CENTERING SM1', value: 'Centraje de pescados' },
      { label: 'SLIT KNIFE SM2', value: 'Cuchilla abridora' },
      { label: 'SUCTION DEV. SM3', value: 'Aspirador' },
      { label: 'SCRAPER A SM4', value: 'Excavador A' },
      { label: 'SCRAPER B SM5', value: 'Excavador B' },
      { label: '∑ E82x', value: 'Veces que ESE motor no alcanzó su posición cero en producción y el ordenador PARÓ la máquina (E821 = SM1, E822 = SM2, y así)' },
      { label: '∑ E82x-C', value: 'Veces que falló pero el ordenador lo CORRIGIÓ solo, sin parar. Señal temprana: sube antes de que empiecen las paradas' },
      { label: '/1000Fi', value: 'Correcciones por cada 1000 pescados. Aparece recién tras 1000 pescados elaborados; sirve para comparar motores sin que el volumen distorsione' },
      { label: '∑ ANUS-O', value: 'Fallos de cuchilla de punta (palpador de ano del lado de entrada) que pararon la máquina; también con su /1000Fi' },
    ],
    note: 'Se leen en el Esquema de programas del control (manual 142, págs 45-46). El motor con el /1000Fi más alto es el candidato a intervenir aunque todavía no pare la máquina.',
  },
  {
    title: 'Limpieza',
    rows: [
