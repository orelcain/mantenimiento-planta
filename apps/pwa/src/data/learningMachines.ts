...
export const LEARNING_MACHINES: LearningMachine[] = [
  ...
  },
  {
    ...
    modulo: 1,
    nivel: 1,
    description: 'Curso NFPA 70E 2024: seguridad eléctrica en lugares de trabajo. Los 3 peligros (choque, arco, ráfaga), efectos de la corriente, 5 Reglas de Oro, bloqueo/etiquetado (LOTO), fronteras de aproximación, EPP y jerarquía de control.',
    icon: Zap,
    color: '#3b6fa8',
    sections: { manual: true, procedures: true, flows: true, diagnosis: true },
  },
  {
    ...
    modulo: 2,
    nivel: 1,
    description: 'Curso NFPA 70E: rescate eléctrico y soporte vital básico (SVB). Peligros eléctricos, 5 Reglas de Oro, control de hemorragias, RCP 30:2 y evaluación ABCDE.',
    icon: HeartPulse,
    color: '#b14a5a',
    sections: { manual: true, procedures: true, flows: true, diagnosis: true },
  },
  {
    ...
    modulo: 3,
    nivel: 1,
    description: 'Norma NFPA 70B 2023: mantenimiento del equipo eléctrico. MEP, 4 pilares, criticidad y riesgo, tipos de mantenimiento, pruebas (termografía, puesta a tierra) y mejora continua (PHVA).',
    icon: ShieldCheck,
    color: '#bf8b3e',
    sections: { manual: true, procedures: true, flows: true, diagnosis: true },
  },
  {
    ...
    modulo: 4,
    nivel: 1,
    description: 'Código Eléctrico Nacional NFPA 70 (NEC) 2023 + reglamentos SEC (RIC / RPTD). Estructura y lenguaje del código, Artículo 110 y 250, puesta a tierra, protecciones (disyuntor, diferencial, SPD, AFDD), dimensionamiento de conductores (sobrecarga, caída de tensión, cortocircuito) y cálculo de protecciones.',
    icon: Cable,
    color: '#3f7c78',
    sections: { manual: true, procedures: true, flows: true, diagnosis: true },
  },
  {
    ...
    area: CAPACITACION_AREA,
    programa: 'Capacitación interna - Operación y Mantención',
    nivel: 1,
    description: 'Cómo clasificar correctamente las detenciones de línea según la estructura vigente: 6 categorías y 46 causales (Abastecimiento / Servicios, Eléctrica, Mecánica, MMPP, Operacionales, Paros Programados). La regla causa-vs-efecto, los errores típicos y qué pasa con el dato después (cascada de pérdidas, Pareto, MTTR).',
    icon: Tags,
    color: '#6b5b95',
    sections: { manual: true, procedures: true, flows: true, diagnosis: true },
  },
