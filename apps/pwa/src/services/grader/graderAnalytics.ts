...
// ── Submódulos extraídos (M14 — 2026-04-22) ──────────────────────────────────
// graderAnalyticsThroughput: CALIBRE_WEIGHT_RANGES, MARELEC_MS4_12_SPECS,
//   DEFAULT_PHYSICAL_CONFIG, computeBeltSpeedFromVfd, computeZetaBeltSpeedMps,
//   estimateZetaThroughput
// graderAnalyticsClassifier: classifyError, classifyRecordToMatrix,
//   computePointZeroClassification
// Re-exportados para mantener compatibilidad con todos los importadores existentes.
// ─────────────────────────────────────────────────────────────────────────────
import {
  CALIBRE_WEIGHT_RANGES,
  MARELEC_MS4_12_SPECS,
  DEFAULT_PHYSICAL_CONFIG,
  computeBeltSpeedFromVfd,
  computeZetaBeltSpeedMps,
  estimateZetaThroughput,
} from './graderAnalyticsThroughput'
...
// ============================================================================
// HELPER LOCAL (solo usado en computeAnalytics)
// ============================================================================
