...
const VISUAL_BY_PERIOD: Record<'mañana' | 'tarde' | 'noche',
  ...
  'mañana': { period: 'mañana', textColorClass: 'text-amber-600 dark:text-amber-400',  bgColorClass: 'bg-amber-500/10',  borderColorClass: 'border-amber-500/30',  iconName: 'Sun',    emoji: '☀',  isDayLike: true  },
  'tarde':  { period: 'tarde',  textColorClass: 'text-orange-600 dark:text-orange-400', bgColorClass: 'bg-orange-500/10', borderColorClass: 'border-orange-500/30', iconName: 'Sunset', emoji: '🌅', isDayLike: true  },
  'noche':  { period: 'noche',  textColorClass: 'text-indigo-600 dark:text-indigo-400', bgColorClass: 'bg-indigo-500/10', borderColorClass: 'border-indigo-500/30', iconName: 'Moon',   emoji: '🌙', isDayLike: false },
}
