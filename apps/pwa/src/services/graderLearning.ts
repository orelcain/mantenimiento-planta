...
function queEsSection(): ManualSection {
  return mk('grader-manual-que-es', 1, 'El clasificador MS4/12: qué hace y cómo clasifica', {
    ...
    content: [
      ...
      '- Precisión (DESVIACIÓN ESTÁNDAR, no tolerancia máxima): stdev 20 g entre 0–5 kg · stdev 50 g entre 5–15 kg',
      ...
      'Notas operativas:',
      '- ⚠ Los 20 g del fabricante son DESVIACIÓN ESTÁNDAR (manual MS4/12 pág 6: "stdev: 20 g"), no un límite de aceptación: con stdev de 20 g, alrededor de un tercio de las pesadas cae legítimamente fuera de ±20 g. NO confundirlo con el criterio de ±20 g de la contrastación, que es otra cosa y viene del instructivo de calibración de planta, no del manual. Usar el stdev como gatillo de recalibración lleva a recalibrar pockets sanos y a rechazar pesajes correctos.',
    ...
    quiz: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'El rango es 0–15 kg. La precisión del fabricante se expresa como desviación estándar: stdev 20 g bajo 5 kg y stdev 50 g entre 5 y 15 kg (manual pág 6). No es una tolerancia máxima: con stdev 20 g, parte de las pesadas cae fuera de ±20 g sin que el equipo esté fallado.',
      },
    ],
  })
}
...
function parametersSection(): ManualSection {
  ...
  return {
    ...
    content: [
      ...
      '- Peso patrón de contrastación: 5 000 g exactos (el patrón NO tiene tolerancia)',
      '- Diferencia de lectura que obliga a recalibrar: más de ±20 g respecto de los 5 000 g',
      '- Presión de aire: ≥ 7 bar (0,70 MPa), aire seco',
      'Criterio interno de Mantención ANTARFOOD (NO es especificación del fabricante):',
      '- Objetivo P0 (rechazo): < 2 %. Ni el manual Marelec MS4/12, ni el instructivo "Basculas Grader", ni el SOP CH-MT-ME-0002 fijan un objetivo porcentual para el punto cero: es una meta que se puso Mantención, y es la que dispara automáticamente el runbook de contrastación.',
      'Puntos clave:',
      ...routes,
      'Notas operativas:',
...
function probarSalidasSection(): ManualSection {
  return mk('grader-manual-probar-salidas', 5, 'Probar salidas: pockets, flippers y capachos', {
    ...
    content: [
      ...
      '⚠ Los comandos de flipper y de capacho NO son rangos continuos: se intercalan. Ingresar un número del grupo equivocado acciona la otra salida en plena producción.',
      'Flippers de la cinta larga:',
      '- Flippers 1 a 4: comandos 133, 134, 135, 136.',
      '- Flippers 5 a 8: comandos 141, 142, 143, 144.',
      '- Flippers 9 a 12: comandos 149, 150, 151, 152.',
      'Capachos de la cinta larga (se cierran cuando el bandejón está lleno, para dar tiempo al operador a llenar los carros):',
      '- Capachos 1 a 4: comandos 137, 138, 130 (así figura en el manual — VERIFICAR EN MÁQUINA, probablemente 139), 140.',
      '- Capachos 5 a 8: comandos 145, 146, 147, 148.',
      '- Capachos 9 a 12: comandos 153, 154, 155, 156.',
      'Notas operativas:',
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          'Se acciona el FLIPPER 5: los comandos se intercalan y 141 es de flipper',
          'Se activan todos los capachos a la vez',
        ],
        correctIndex: 2,
        explanation: 'Los grupos se intercalan: 141-144 son flippers 5-8, y el capacho 5 es el 145. Tipear un número del grupo equivocado acciona la otra salida en plena producción — por eso no hay que memorizarlos como rango continuo.',
      },
      {
        question: '¿Qué comandos corresponden a los flippers 9 a 12 de la cinta larga?',
        options: ['145 a 148', '149, 150, 151, 152', '141 a 144', '153 a 156'],
        correctIndex: 1,
        explanation: 'Flippers: 133-136 (1-4), 141-144 (5-8) y 149-152 (9-12). Los 145-148 y 153-156 son capachos.',
      },
      {
...
function limpiezaSection(): ManualSection {
  return mk('grader-manual-limpieza-mantencion', 7, 'Limpieza y plan de mantención (día / mes / semestre)', {
    ...
    content: [
      ...
      'Notas operativas:',
      '- Cada mes: revisar juego en la parte de arriba de los flippers (juego VERTICAL → cambiar los rodamientos del flipper, 6005 2RSR, 2 por módulo; juego HORIZONTAL → cambiar los rodamientos de bolas del vástago del cilindro neumático), igualar la velocidad de los cilindros y probar botones, lámparas, interruptor y parada de emergencia.',
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['Los rodamientos del flipper (6005 2RSR)', 'Los bujes', 'La celda de carga', 'La cinta'],
        correctIndex: 0,
        explanation: 'Juego VERTICAL → cambiar los rodamientos del flipper (manual MS4/12 pág 25: "If there is a vertical clearance on the flippers, replace the bearings"). El despiece de pág 58 los identifica como 6005 2RSR, 2 por módulo de flipper. El juego HORIZONTAL es el que se corrige cambiando los rodamientos de bolas del vástago del cilindro neumático.',
      },
    ],
  })
}
