...
- 🔲 **Pendiente sesión:** favoritos de equipos desde el sidebar (estrella por equipo) + "ver solo favoritos" que incluya equipos (hoy el toggle de favoritos del sidebar solo filtra áreas).
