...
- 🔲 **Incremento 3:** sub-equipos (hijos numéricos de un equipo) anidados en el árbol; hoy solo se muestra 1 nivel (equipos directos del área). Requiere lazy-load de hijos de equipo (no cargados por `useHierarchyAreaTree`) + hacer expandibles las filas de equipo.
