...
- **fix-ci**: Usar systematic-debugging para diagnosticar la causa raíz antes de aplicar cualquier fix de CI
- **audit-unused-locals**: Si aparecen variables huérfanas inesperadas, trazar hacia atrás el refactor que las dejó
