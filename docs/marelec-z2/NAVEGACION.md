...
- ⏳ **Siguiente**: pantallas P2 restantes (Explorar CAN bus, Localizar IDs, Idioma, Ajustes Red, Fecha/hora, eventos de sistema — Lote 4 original del spec) o reconciliar el diccionario bilingüe con `labelForField()`/`graderGlossary.ts`.
