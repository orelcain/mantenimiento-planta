...
lineas = [
    ...
    "",
    "Generado 2026-08-23 desde el plano 888 + catálogo de piezas. **Cómo usarlo**:",
    "el componente físico lleva su designación rotulada (K7, Y12…). Ubícalo, lee",
    "el rótulo/modelo de la pieza y anótalo. Con eso el vínculo pasa a",
    "**confirmado** en la app (badge verde) y queda con su SAP.",
    "En la app: `Aprendizaje → Planos → BAADER 142` (toca el aparato) y",
    "`BAADER 142 · PLANO DE PARTES` (las figuras de referencia).",
    "",
